            ...
            <div className='container-fluid'>
                <div className='container'>
                    ...
                    <div className='col-lg-12'>
                        <button type='button' className='btn btn-dark' onClick={this.handPrevClick}>&larr; Previous</button>
                        <button type='button' className='btn btn-dark' onClick={this.handNextClick}></button>
                    </div>
                </div>
            </div>
        );
