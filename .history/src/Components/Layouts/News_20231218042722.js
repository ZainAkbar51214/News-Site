...
class News extends Component {
    ...
    async componentDidMount(){
        ...
        let url = `https://newsapi.org/v2/everything?country=${this.props.country}&category=${this.props.category}&from=2023-11-17&sortBy=publishedAt&apiKey=e5869a5b7afe45f0975749f435cea4b5`;
