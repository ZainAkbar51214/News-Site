...
class News extends Component {
    ...
    async componentDidMount(){
        let url = "https://newsapi.org/v2/top-headlines?apiKey=ad02bf3d34a0416cb244eb374fced0bb&q=news&page=1&pageSize=20";
            ...
            <div className='container-fluid'>
                <div className='container'>
                   ...
                   <div className='col-lg-12 d-flex justify-content-between mt-5 mb-5'>
                        ...
                        <button disabled={this.state.page + 1 > Math.ceil(this.state.totalResults/20)} type='button' className='btn btn-dark' onClick={this.handNextClick}>Next &rarr;</button>
                    </div>
                   </div>
                </div>
            </div>
