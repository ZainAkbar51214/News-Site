                ...
                <div className='container'>
                    <div className='row'>
                        {this.state.articles.map((element) => {
                           return <div className='col-lg-3 mt-5' key={element.url}>
                           <NewsItem title={element.title.slice(0, 61)} description={element.description.slice(0, 86)} imageUrl={element.urlToImage} newsUrl={element.url} />
                       </div> 
                        })}
