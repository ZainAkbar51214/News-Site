...
class News extends Component {
    ...
    async componentDidMount(){
        ...
        let url = `https://newsapi.org/v2/everything?&country=${this.props.country}&category=${this.props.category}&apiKey=ad02bf3d34a0416cb244eb374fced0bb&q=news&page=1&pageSize=${this.props.pageSize}`;
