...
class News extends Component {
    ...
    async componentDidMount(){
        let url = `https://newsapi.org/v2/top-headlines?&country=${this.props.country}&category=${this.props.category}ad02bf3d34a0416cb244eb374fced0bb&q=news&page=1&pageSize=${this.props.pageSize}`;
    ...
    handPrevClick = async () => {
        console.log("prev");
        let url = `https://newsapi.org/v2/top-headlines?&country=${this.props.country}&category=${this.props.category}ad02bf3d34a0416cb244eb374fced0bb&q=news&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        this.setState({loading: true});
        let data = await fetch(url);
        let passData = await data.json();
        console.log(passData);
